...
class AboutDialogView(Drawable):
    def __init__(self, about_dialog):
        ...
        self._version_text = FONT_SECONDARY_SMALL.render(u'版本 ' + VERSION, True, Color.WHITE)
        ...
        self._license_url_text = FONT_SECONDARY_XSMALL.render(u'Game assets are published under their own licenses.', True, Color.WHITE)
        self._asset_license_text = FONT_SECONDARY_XSMALL.render(u'原始代码 <https://github.com/plbrault/youre-the-os>', True, Color.WHITE)
